...
const HomePage = () => {
    return (
        ...
        <div className='px-3 sm:px-10 py-4 bg-[#F7F7F7] w-screen h-screen'>
            ...
            <p className='text-[#000] text-lg my-5 font-medium'>Welcome, Stuart</p>

            <div className='flex items-start gap-x-3 md:mt-[0rem] flex-wrap'>
                ...
                <div className='mt-2 flex-1 '>
                    <div className='w-[100%] bg-[#FAF8F8] rounded-3xl shadow-xl border border-[#FFFEFE] py-3 px-5 h-[14.5rem] flex justify-center items-center'>
